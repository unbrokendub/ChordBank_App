...
private let log = Logger(subsystem: "unbrokendub.ChordBank.ChordBankMIDI", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<ChordBankMIDIMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try ChordBankMIDIAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? ChordBankMIDIAudioUnit else {
            log.error("Unable to create ChordBankMIDIAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(ChordBankMIDIParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = ChordBankMIDIMainView(parameterTree: observableParameterTree)
