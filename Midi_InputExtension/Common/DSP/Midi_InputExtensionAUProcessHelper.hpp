//
//  Midi_InputExtensionAUProcessHelper.hpp
//  Midi_InputExtension
//
...
#include <vector>
#include "Midi_InputExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(Midi_InputExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    Midi_InputExtensionDSPKernel& mKernel;
