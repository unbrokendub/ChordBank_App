...
private let log = Logger(subsystem: "unbrokendub.Midi-InputExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<Midi_InputExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try Midi_InputExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? Midi_InputExtensionAudioUnit else {
            log.error("Unable to create Midi_InputExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(Midi_InputExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = Midi_InputExtensionMainView(parameterTree: observableParameterTree)
