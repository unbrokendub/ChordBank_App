//
//  Midi_InputExtensionDSPKernel.hpp
//  Midi_InputExtension
//
...
#import "Midi_InputExtension-Swift.h"
#import "Midi_InputExtensionParameterAddresses.h"

/*
 Midi_InputExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class Midi_InputExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in Midi_InputExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case Midi_InputExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<Midi_InputExtensionDSPKernel *>(context);
